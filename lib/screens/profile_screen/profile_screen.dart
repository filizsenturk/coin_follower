    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              child: Text(Strings.cSend),
              onPressed: () {
                final docUser =
                    FirebaseFirestore.instance.collection('users').doc(email);
                docUser
                    .update({update: changeController.text.trim().toString()});
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ProfileInfoRow(
                        text: Strings.cSurName,
                        value: users.surname,
                        onTap: onSurnameTapped,
                      ),
                      ProfileInfoRow(
                        text: Strings.cCountry,
                        value: users.country ?? "",
                        onTap: () {},
                      ),
                      ProfileInfoRow(
                        text: Strings.cBirthday,
                        value: users.birthday.toString() ?? "",
                        onTap: () {},
                      ),
                      buildHomeScreenIcon()
                    ],
